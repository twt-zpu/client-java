...
import eu.arrowhead.client.consumer.exception.ErrorMessage;
import eu.arrowhead.client.consumer.exception.UnavailableServerException;
import eu.arrowhead.client.consumer.json.JacksonJsonProviderAtRest;
import java.io.File;
...
final class Utility {
  ...
  static <T> Response sendRequest(String uri, String method, T payload) {
    ...
    if (uri.startsWith("https")) {
      ...
      // building hostname verifier to avoid eu.arrowhead.clientcommon.exception
  ...
  private static void handleException(Response response, String uri) {
    ...
    if (errorMessage == null || errorMessage.getExceptionType() == null) {
      ...
      System.out.println("Origin of the eu.arrowhead.clientcommon.exception:" + errorMessage.getOrigin());
      System.exit(-1);
    }
  }
