...
public final class Utility {
  ...
  public static SSLContextConfigurator setSSLContext(String keystore, String keystorepass, String keypass,
    ...
    if (keystore != null) sslCon.setKeyStoreFile(keystore);
    if (keystorepass != null) sslCon.setKeyStorePass(keystorepass);
    if (keypass != null) sslCon.setKeyPass(keypass);
    if (truststore != null) sslCon.setTrustStoreFile(truststore);
    if (truststorepass != null) sslCon.setTrustStorePass(truststorepass);

    if (!sslCon.validateConfiguration(needsKeyStore)) {
