...
package eu.arrowhead.client.subscriber.common.exception;
 ...
 * operation (after core systems servers started listening for requests). <p> If this eu.arrowhead.clientcommon.exception is thrown at server
 * startup, it signals a problem with
