...
package eu.arrowhead.client.provider.common.security;

import eu.arrowhead.client.provider.Utility;
...
@Provider
@Priority(Priorities.AUTHORIZATION) //2nd highest priority constant, this eu.arrowhead.clientcommon.filter gets executed after the SecurityFilter
